 ...
 * @author jhierrot
 */
public class ListTaskEvents extends ListObjects
{
/**
 * 
 * @param parent
 ...
 * @param pPDObject
 */
public ListTaskEvents(java.awt.Frame parent, boolean modal, ObjPD pPDObject)
{
...
{
MantTaskEvents MU = new MantTaskEvents(Fparent, true);
...
{
MantTaskEvents MU=(MantTaskEvents)MantForm;
if (MU.isCancel())
    return(false);
...
{
setTitle(MainWin.TT("Task_Event_Maintenance"));
