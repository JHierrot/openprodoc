...
{   
PDFolders TmpFold=new PDFolders(SParent.getSessOPD(Req), getSoftProviderType(Req));    
...
Vector<String> SoftCompFields = getSoftProvFields(Req);
...
TmpFold.setParentId(getSoftProvRoot(Req));
switch (Oper2)
    {case ADD:
        TmpFold.insert();
        break;
