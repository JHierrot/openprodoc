...
if (RepositoriesStruct==null)
    ...
    R.addAttr( new Attribute(fURL, "URL", "URL_URI_Repository_reference", Attribute.tSTRING, true, null, 256, false, false, true));
    R.addAttr( new Attribute(fPARAM, "Additional_parameters", "Additional_parameters", Attribute.tSTRING, false, null, 256, false, false, true));
