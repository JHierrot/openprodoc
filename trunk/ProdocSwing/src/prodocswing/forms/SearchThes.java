 ...
 * @author jhierrot
 */
public class SearchThes extends javax.swing.JDialog
{
 ...
 * @param modal 
 */
public SearchThes(JDialog parent, boolean modal)
{
super(parent, modal);
initComponents();
try {
    setRecord(PDThesaur.getRecordStructPDThesaur());
...
Cancel = false;
PDThesaur Thes=new PDThesaur(MainWin.getSession());
Cursor Cur=Thes.Search(getConds(), getSubFold(), ActFolderId, null);
ListTerms LF = new ListTerms(this, true);
