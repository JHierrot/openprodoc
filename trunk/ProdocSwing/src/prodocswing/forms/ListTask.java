...
if (TimeStampFilter1.getText().length()!=0)
    ...
    Condition C1=new Condition(PDTasksExec.fSTARTDATE, Condition.cGET , d1);  
    Conds1.addCondition(C1);
    Condition C2=new Condition(PDTasksExec.fENDDATE, Condition.cGET , d1);  
...
if (TimeStampFilter2.getText().length()!=0)
    ...
    Condition C1=new Condition(PDTasksExec.fSTARTDATE, Condition.cLET , d1);  
    Conds1.addCondition(C1);
    Condition C2=new Condition(PDTasksExec.fENDDATE, Condition.cLET , d1);  
    Conds1.addCondition(C2);
    Conds.addCondition(Conds1);
    }
if (Conds.NumCond()==0)
