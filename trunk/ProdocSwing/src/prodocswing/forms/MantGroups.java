 ...
 * @author jhierrot
 */
public class MantGroups extends javax.swing.JDialog
{
private Record Group;
private boolean Cancel;
private PDGroups EditGroup;
Frame Fparent;
 ...
 * @param modal
 */
public MantGroups(java.awt.Frame parent, boolean modal)
{
super(parent, modal);
Fparent=parent;
try {
initComponents();
EditGroup = new PDGroups(MainWin.getSession());
...
UsersTable.setAutoCreateColumnsFromModel(true);
    ...
    private void initComponents() {
        ...
        GrpNameLabel = new javax.swing.JLabel();
        GrpDescripLabel = new javax.swing.JLabel();
        ACLDescripLabel = new javax.swing.JLabel();
        GrpNameTextField = new javax.swing.JTextField();
        GrpDescripTextField = new javax.swing.JTextField();
        ...
        GrpNameLabel.setFont(MainWin.getFontDialog());
        GrpNameLabel.setText("jLabel1");

        GrpDescripLabel.setFont(MainWin.getFontDialog());
        GrpDescripLabel.setText("jLabel1");

        ACLDescripLabel.setFont(MainWin.getFontDialog());
        ACLDescripLabel.setText("jLabel1");

        GrpNameTextField.setFont(MainWin.getFontDialog());

        GrpDescripTextField.setFont(MainWin.getFontDialog());
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(ACLDescripLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(GrpNameLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(GrpDescripLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(GrpNameTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 267, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(GrpDescripTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 443, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(ACLComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 265, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        );

        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {ACLDescripLabel, GrpDescripLabel, GrpNameLabel});
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(GrpNameTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(GrpNameLabel))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(GrpDescripTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(GrpDescripLabel))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
...
try {
Attribute Attr=Group.getAttr(PDGroups.fNAME);
Attr.setValue(GrpNameTextField.getText());
Attr=Group.getAttr(PDGroups.fDESCRIPTION);
Attr.setValue(GrpDescripTextField.getText());
Attr=Group.getAttr(PDGroups.fACL);
...
Record r=grp.getRecordGroupGroupsStruct();
...
String GrpName=(String)r.getAttr(PDGroups.fMEMBERNAME).getValue();
grp.addGroup(GrpName);
RefreshGroups(grp.getName());
} catch (PDException ex)
    {MainWin.Message(MainWin.DrvTT(ex.getLocalizedMessage()));
    }
...
if (MP.isCancel())
    return;
String GrpName=(String) MP.getRecord().getAttr(PDGroups.fMEMBERNAME).getValue();
Grp.delGroup(GrpName);
RefreshGroups(Grp.getName());
} catch (PDException ex)
    {MainWin.Message(MainWin.DrvTT(ex.getLocalizedMessage()));
    }
...
PDGroups Grp=new PDGroups((MainWin.getSession()));
Grp.setName((String)Group.getAttr(PDGroups.fNAME).getValue());
Record r=Grp.getRecordGroupUsersStruct();
...
if (MP.isCancel())
    return;
r.assign(MP.getRecord());
String User=(String)r.getAttr(PDGroups.fUSERNAME).getValue();
Grp.addUser(User);
RefreshUsers(Grp.getName());
} catch (PDException ex)
    {MainWin.Message(MainWin.DrvTT(ex.getLocalizedMessage()));
    }
...
if (MP.isCancel())
    return;
String User=(String) MP.getRecord().getAttr(PDGroups.fUSERNAME).getValue();
Grp.delUser(User);
RefreshUsers(Grp.getName());
} catch (PDException ex)
    {MainWin.Message(MainWin.DrvTT(ex.getLocalizedMessage()));
    ...
    private javax.swing.JLabel GrpDescripLabel;
    private javax.swing.JTextField GrpDescripTextField;
    private javax.swing.JLabel GrpNameLabel;
...
GrpNameTextField.setEditable(false);
GrpDescripTextField.setEditable(false);
}
//----------------------------------------------------------------
/**
*
...
GrpNameTextField.setText(GrpNameTextField.getText()+"1");
}
//----------------------------------------------------------------
/**
* @return the ACL
 ...
 * @param pGrp
*/
public void setRecord(Record pGrp)
{
try {
Group = pGrp;
Attribute Attr = Group.getAttr(PDGroups.fNAME);
GrpNameLabel.setText(Attr.getUserName());
if (Attr.getValue() != null)
    {
    GrpNameTextField.setText((String) Attr.getValue());
    RefreshUsers((String)Attr.getValue());
    RefreshGroups((String)Attr.getValue());
    }
GrpNameTextField.setToolTipText(Attr.getDescription());
Attr = Group.getAttr(PDGroups.fDESCRIPTION);
GrpDescripLabel.setText(Attr.getUserName());
if (Attr.getValue() != null)
    {
    GrpDescripTextField.setText((String) Attr.getValue());
    }
GrpDescripTextField.setToolTipText(Attr.getDescription());
Attr=Group.getAttr(PDGroups.fACL);
ACLDescripLabel.setText(Attr.getUserName());
if (Attr.getValue()!=null)
    ACLComboBox.setSelectedItem((String)Attr.getValue());
ACLComboBox.setToolTipText(Attr.getDescription());
} catch (PDException ex)
    {
    MainWin.Message(MainWin.DrvTT(ex.getLocalizedMessage()));
    }
...
//----------------------------------------------------------------
private void RefreshUsers(String GrpName) throws PDException
{
UsersMembers = new PDTableModel();
UsersMembers.setDrv(MainWin.getSession());
UsersMembers.setListFields(EditGroup.getRecordGroupUsersStruct());
UsersMembers.setCursor(EditGroup.ListUsers(GrpName ));
...
GroupsMembers.setListFields(EditGroup.getRecordGroupGroupsStruct());
GroupsMembers.setCursor(EditGroup.ListGroups(AclName));
