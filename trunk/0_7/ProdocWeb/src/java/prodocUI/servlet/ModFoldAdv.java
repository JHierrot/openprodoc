 ...
 * @author jhierrot
 */
public class ModFoldAdv extends SParent
{
...
if (!Reading(Req))
    ...
    FMantFoldAdv f=new FMantFoldAdv(Req, FMantFoldAdv.EDIMOD, Rec, getUrlServlet());
...
//        GenListForm(Req, out, LAST_FORM, "parent.ExpandContract('"+ParentNewTabId+"',"+ParentRowId+", '"+ParentFoldId+"', 4)", null);
