...
if (DocsStruct==null)
    ...
    R.addAttr( new Attribute(fTITLE, "Document_Title", "Document_Title", Attribute.tSTRING, true, null, 256, false, false, true));
    ...
    R.addAttr( new Attribute(fNAME, "File_name", "File_name", Attribute.tSTRING, true, null, 256, false, false, false));
