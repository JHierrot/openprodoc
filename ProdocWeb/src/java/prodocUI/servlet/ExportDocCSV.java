 ...
 * @author Joaquin
 */
public class ExportDocCSV extends SParent
{
@Override
...
PDDocs D = new PDDocs(getSessOPD(request));
...
Cursor Res = D.Search(FTQuery, FType, Cond, SubT, SubF, Vers, actFolderId, Ord);
...
{
return "Export Doc results in CSV format Servlet";
}
//-----------------------------------------------------------------------------------------------
