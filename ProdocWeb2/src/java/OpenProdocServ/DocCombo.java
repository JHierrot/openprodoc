...
Form.append("{type: \"combo\", name: \"" + PDDocs.fDOCTYPE + "\",offsetLeft:10,label: \"").append(TT(Req, Attr.getUserName())).append("\", required: true, tooltip:\"").append(TT(Req, Attr.getDescription())).append("\", options:[");
