...
CurrentSession CS=new CurrentSession(D.getUser().getName(), new Date(), Req.getRemoteHost(), D, CurrentSession.Mode.REST);
...
CS=new CurrentSession(D.getUser().getName(), new Date(), Req.getRemoteHost(), D, CurrentSession.Mode.REST);
