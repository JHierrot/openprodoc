...
"<html>" +
    ...
    "<body class=\"CONTRIBBODY\" >\n" +
       "<form action=\"ContribAdd2\" method=\"post\" class=\"CONTRIBFORM\">" +
       "<table align=\"center\"  class=\"CONTRIBTABLE\">\n" +
        ...
        "<fieldset class=\"CONTRIBFS\"><legend class=\"CONTRIBLEG\">&nbsp;&nbsp;@DOCTITLE@&nbsp;&nbsp;</legend>\n"+
         "<table>\n" +   
          "@CONTRIB_DOCFIELDS@"+
          "<tr></tr><tr><td><a class=\"CONTRIBHELP\" href=\"@URLHELP@\" target=\"_blank\">?</a></td><td><a class=\"CONTRIBBUT\" href=\"ContribList\" ><-</a><input  class=\"CONTRIBBUT\" type=\"submit\" value=\"  +  \"></td></tr>" +
          "</table>\n" +
         "</fieldset>" +
        "</td></tr>" +
       "</table>\n"+        
